...
def generate_games():
    ...
    game_prefixes = [
        "Adventure", "Battle", "Castle", "Dragon", "Epic", "Fantasy", "Galaxy", "Hero", "Island", "Journey",
        "Kingdom", "Legend", "Magic", "Night", "Ocean", "Quest", "Racing", "Space", "Tower", "Warrior",
        "Zombie", "Cyber", "Steam", "Pixel", "Retro", "Arcade", "RPG", "Strategy", "Action", "Puzzle"
    ]
    
    game_suffixes = [
        "Quest", "Adventure", "Battle", "Chronicles", "Legends", "Wars", "Empire", "Kingdom", "Realm", "World",
        "Story", "Tales", "Saga", "Trilogy", "Collection", "Edition", "Deluxe", "Ultimate", "Pro", "Plus"
    ]
    
    app_prefixes = [
        "Office", "Design", "Edit", "Create", "Build", "Manage", "Analyze", "Process", "Convert", "Optimize",
        "Secure", "Backup", "Monitor", "Control", "Connect", "Share", "Sync", "Store", "Organize", "Plan"
    ]
    
    app_suffixes = [
        "Pro", "Studio", "Suite", "Tool", "Manager", "Editor", "Creator", "Builder", "Analyzer", "Converter",
        "Optimizer", "Protector", "Backup", "Monitor", "Controller", "Connector", "Organizer", "Planner"
    ]
    ...
    if not any(game["name"] == "A Good Snowman Is Hard To Build" for game in games_data):
        games_data.insert(0, {"name": "A Good Snowman Is Hard To Build", "category": "game", "enabled": False})
